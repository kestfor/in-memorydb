...
//	c := NewPNCounter("a")
//	if got := c.Type(); got != CRDTTypePNCounter {
//		t.Errorf("Type() = %q, want %q", got, CRDTTypePNCounter)
//	}
//}
//
...
//
//func (m *mockDelta) Type() CRDTType                 { return CRDTTypePNCounter }
...
//
//func (m *mockCRDT) Type() CRDTType                 { return CRDTTypePNCounter }
